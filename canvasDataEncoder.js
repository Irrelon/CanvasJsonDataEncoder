function encode(canvas, x, y, maxX, data) {
	...
	console.log('Encoding string: ' + stringData);
	...
	for (i = 0; i < stringData.length; i += 3) {
		...
		console.log('Encoded "' + stringData[i] + '" with data ' + quartet[0]);
		console.log('Encoded "' + stringData[i + 1] + '" with data ' + quartet[1]);
		console.log('Encoded "' + stringData[i + 2] + '" with data ' + quartet[2]);
	...
	for (i = 0; i < quartets.length; i++) {
		quartet = quartets[i];
		console.log('Painting:', quartet[0] + ', ' + quartet[1] + ', ' + quartet[2] + ', 255');
